...
[_index] spawn {
    ...
    if (!GVAR(askDeleteConfirmation) || {[format [LLSTRING(deleteConfirmation), _profile], localize "str_a3_a_hub_misc_mission_selection_box_title", localize "str_disp_xbox_hint_yes", localize "str_disp_xbox_hint_no"] call BIS_fnc_guiMessage}) then {
